/**
 * SQLite database access layer for the CSSF Luxembourg MCP server.
 *
 * Schema mirrors the CSSF regulatory structure:
 *   - sourcebooks         — top-level CSSF document categories (Circulaires, Reglements, FAQ, Communiques)
 *   - provisions          — individual articles, requirements, and guidance entries
 *   - enforcement_actions — CSSF enforcement decisions and sanctions
 *
...
export function getProvision(
  ...
  // Fuzzy fallback: case-insensitive reference match
  return (
    (db
      .prepare(
